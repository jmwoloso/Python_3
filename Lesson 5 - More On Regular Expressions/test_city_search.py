...
# Lesson 5 - Exercise 5
"""
test_city_search.py: Test suite for city_search.py
...
000-000-0000 or 555-555-0000. Well, I will try (555) 123-4567 again now."""
...
class TestRegex(unittest.TestCase):
    ...
    def test_city_search(self):
        self.assertEqual("Washington, DC 20002",
                         city_search(p2))
        self.assertEqual("Falls Church, VA 20188",
                         city_search(p3))
